...
# arr_tr.push(tr1)
# arr_tr.push(tr2)
arr_tr[0] = Transactions.new('12/02/18', 'description 1', 12.89)
arr_tr[1] = Transactions.new('02/03/18', 'description 2', 50.16)
